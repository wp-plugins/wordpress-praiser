...
Yes. Edit the praises-widget.css file that comes along with the plug-in, there are instruction in the file.
...
3. A praise in the sidebar
4. A full page of praises
