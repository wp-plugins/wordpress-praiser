...
$wp_praiser_db_version = '1.2'; 

require_once('wp-praiser-widget.php');
require_once('wp-praiser-admin.php');

function wp_praiser_display_praises($title = '', $random = 1, $min_height, $refresh_interval = 5, $show_source = 0, $show_author = 1, $tags = '', $char_limit = 500, $char_size = 11, $full_page = 0)
{
