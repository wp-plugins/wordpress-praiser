...
//		$img_name = str_replace("&#47;", "/", $img_name);
	...
	$img_name_label = __('Picture', 'wp-praiser');
...
<form name="{$form_name}" method="post" action="{$action_url}">
	...
	<table class="form-table" cellpadding="5" cellspacing="2" width="100%">
		...
		<tr>
			...
			<td valign="top"><input type="text" id="wp_praiser_img_name" name="img_name" size="50" value="{$img_name}" />&nbsp;&nbsp;If Left blank <img height="30" width="30" src="{$img_generic}"> will be used.
		</tr>
        <tr>
...
{	
	...
	if($praises_list) {
		...
		$display .= "<thead><tr>
			...
			<th>
				".__('Author', 'wp-praiser')." / ".__('Source', 'wp-praiser')."
			</th>
...
//add_shortcode('wp-praiser', array(&$wp-praiser,'wp-praiser_short_code'),1);
//add_shortcode('wp_praiser', array(&$wp-praiser,'wp-praiser_short_code'),1);
?>
